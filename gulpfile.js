...
gulp.task('scripts', function() {
  ...
  function buildTemplates() {
    return gulp.src('src/**/*.html')
      ...
      .pipe(templateCache({module: 'mvsouza.ng-embed-code-form'}));
  };

  function buildDistJS(){
    return gulp.src('src/ng-embed-code-form.js')
      .pipe(plumber({
  ...
  es.merge(buildDistJS(), buildTemplates())
    ...
    .pipe(order([
      'ng-embed-code-form.js',
      'template.js'
    ]))
    .pipe(concat('ng-embed-code-form.js'))
...
gulp.task('styles', function() {
  ...
  return gulp.src('src/ng-embed-code-form.less')
    .pipe(less())
    .pipe(header(config.banner, {
      timestamp: (new Date()).toISOString(), pkg: config.pkg
    }))
